document.addEventListener("DOMContentLoaded", () => {
  ...
  document
    .getElementById("back-board-btn")
    .addEventListener("click", backToMenuFromBoard);
  document
  ...
  document
    .getElementById("menuSugestao")
    .addEventListener("click", abrirSuggestionModal);
  ...
  document.getElementById("closeSuggestion").addEventListener("click", () => {
    enviarCliqueBotao("Menu: Sugestões ou Reclamações Botão Fechar Clicado");
